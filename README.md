...
| 子项目 | 作用 | README |
| --- | --- | --- |
| `comvert-comments-slide` | 在 Google Slides 中把 presentation comments 导出到最后追加的一页 summary slide。 | [comvert-comments-slide/README.md](./comvert-comments-slide/README.md) |
